...
export default function CheckoutScreen() {
  ...
  const { orderSummary, user } = useAuth();
  ...
  return (
    <View className="flex-1 bg-white">
          ...
          <View className="space-y-2.5">
            ...
            <View className="flex-row justify-between pt-2">
              ...
              <Text className="text-base font-bold text-gray-900">
                $
                {isNaN(orderSummary.finalTotal)
                  ? 0
                  : Number(orderSummary.finalTotal).toFixed(2)}
              </Text>
            </View>
          </View>
        </View>
      ...
      <View className="mb-20 bg-white px-6 py-4 border-t border-gray-100">
        <Pressable
          onPress={() => {
            // Handle order confirmation/placement logic
          }}
          disabled={
            !isNaN(orderSummary.subtotal) && Number(orderSummary.subtotal) < 1
          }
